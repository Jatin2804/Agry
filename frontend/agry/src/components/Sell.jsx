...
const Sell = () => {
  ...
  const { loggedIn, userData, billData, setBillData } = useAppContext();
  ...
  const handleSellNow = (product) => {
    ...
    // Snackbar logic
    setSnackbarMessage("Item added to bill");
            ...
            <Grid item xs={12} sm={6} md={3} key={product.id}>
              ...
              >
                ...
                <CardContent>
                  ...
                  <hr />
                  <Typography variant="body2" color={color}>
                    Selling Price : Rs.{product.sp}/kg
                  </Typography>
                </CardContent>
